        ...
        child: Column(
          children: [
            ListTile(
              ...
              subtitle: Text('User Profile',style: TextStyle(color:Theme.of(context).colorScheme.onSecondary ),),
            ),
            SizedBox(width: screenWidth * 0.2, child: Divider(color:Theme.of(context).colorScheme.onSecondary ,)),
            ListTile(
              ...
              subtitle: Text('Log out user',style: TextStyle(color:Theme.of(context).colorScheme.onSecondary ),),
              onTap: () {
                showDialog(
                  context: context,
                  builder:
